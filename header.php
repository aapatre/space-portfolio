...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'spaceportfolio' ); ?></a>
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( ( $spaceportfolio_description || is_customize_preview() ) && ( is_front_page() && is_home() ) ) :  // Display site description only on home page && frontpage.
				?>
		...
		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'spaceportfolio' ); ?></button>
			<?php
			wp_nav_menu(
				array(
